...
<div class="container">
	<div class="row">
		<div class="col">
			...
			<h2 class = "text-center">Z Networks started with a little capital, a big idea, and a huge amount of ambition.</h2>
			</br>
			<h2 class = "text-center">20 years, 1000 clients, 5200 projects, and 395,000 tickets later, we have a bit more capital, even bigger ideas, and the ambition has never been so focused.</h2>
			<div class="row">
								...
								<div class="row py-5">	
									<div class="col-md-4">
										<div class="card" style="width: 100%;">
											<img class="card-img-top" src="https://www.znetworks.com/img/employees/qOaJVY0sGBJPHmObuhEP4X54oywYYu0pja8e99HQLqGsNuEiMj8RgdWFLtDJXE8g-.New%20Hire%20Photo.jpg" alt="Mike Goodman">
											<div class="card-body">
							...
							<div class="card-body">
								<div class="container">
									<div class="row py-5">
										<div class="col-md-4" >
											<div class="card" style="width: 100%;">
												<img class="card-img-top" src="img/employees/Gwen-Bassett.jpg" alt="Gwen Bassett">
												<div class="card-body">
													<h6 class="card-text text-center">Gwen Bassett</h6>
												</div>
											</div>
										</div>
										<div class="col-md-4">
