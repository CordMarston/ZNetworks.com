...
jQuery(function($) {
    ...
    script.src = "https://maps.googleapis.com/maps/api/js?sensor=false&callback=initialize&key=AIzaSyAAOcFDKpurHYXTcs_RZ2MjdvvGRdR6F1Y";
...
['Z Networks - Las Vegas', 36.100890, -115.131806]   ];
...
'<p>1515 East Tropicana Ave<br/>Las Vegas, NV</p>' + '</div>']
    ];
