...
<nav class="navbar navbar-expand-lg navbar-light" id="znws-navbar">
	<div class="container d-flex align-items-center">
		<div class="row-fluid d-md-none">
			...
			<a href="index.php"><img src="https://znetworks.com/blog/wp-content/uploads/2019/10/znetworks-logo.png" style="width:100%;"></a>
			</div>
	  ...
	  <p class="button-custom order-lg-last mb-0 d-none d-md-block text-white"><a href="https://znetworks.com/#consult" class="text-white btn btn-cust-orange py-2 px-2">Schedule Appointment</a></p>
