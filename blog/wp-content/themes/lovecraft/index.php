...
<div class="wrapper section">
	...
	<!-- <div class="section-inner group mt-5"> -->
		...
		<div class="content pages-content">
			...
			<?php if ( have_posts() ) : ?>
				...
				<div class="posts" id="posts">
					...
					endwhile;
					echo do_shortcode('[ajax_load_more id="load-more" images_loaded="true" container_type="div" pause="true" post_type="post, attachment, any" scroll="false" button_loading_label="Loading Posts..." button_done_label="Last Post" offset="2"]'); 
					?>
